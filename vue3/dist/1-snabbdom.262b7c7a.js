...
;
},{"./vnode.js":"../../node_modules/snabbdom/build/package/vnode.js","./is.js":"../../node_modules/snabbdom/build/package/is.js"}],"1-snabbdom.js":[function(require,module,exports) {
"use strict";
...
var learnVNode = function learnVNode() {
  var vdata = {
    // 定义 DOM 的属性
    // 直接给 Element 上添加属性
    props: {
  ...
  var vnode = (0, _h.h)('div.wrap', vdata, ['学习Vue3']);
  patch(app, vnode);
};

var learnHook = function learnHook() {
  // 创建一个虚拟节点
...
var contentVnode = (0, _h.h)('div.content-wrap', vNodeData, [(0, _h.h)('h1', {
  class: '.title'
}), (0, _h.h)('p', {
  style: {
    fontSize: '18px',
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","1-snabbdom.js"], null)
//# sourceMappingURL=/1-snabbdom.262b7c7a.js.map